"""
Django settings for sample application
Minimal configuration for testing dependency upgrades
"""
...
SECRET_KEY = 'django-insecure-test-key-for-dependency-testing-only'
